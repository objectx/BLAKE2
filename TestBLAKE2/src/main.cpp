...
static const size_t	NUM_BLAKE2_TEST = 256 ;
static const size_t	DIGEST_SIZE = 64 ;

static const uint8_t blake2b_keyed_kat[NUM_BLAKE2_TEST][DIGEST_SIZE] = {
  {
...
void	TestBLAKE2 () {
    ...
    BLAKE2::ParameterView	pview (param) ;
    for (size_t i = 0 ; i < NUM_BLAKE2_TEST ; ++i) {
        ...
        for (size_t j = 0 ; j < 64 ; ++j) {
            assert (D.GetByte (j) == blake2b_keyed_kat [i][j]) ;
        }
    }
}
